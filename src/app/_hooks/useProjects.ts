...
export function useProjects({
  ...
  return {
    ...
    editExistingRepoBranches: editor.editExistingRepoBranches,
    editExistingRepoSavingUrl: editor.editExistingRepoSavingUrl,
    ...
    updateExistingRepoBranchInput: editor.updateExistingRepoBranchInput,
    handleUpdateExistingRepoBranch: editor.handleUpdateExistingRepoBranch,
